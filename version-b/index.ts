/*
 * This is a simple example of a custom node that processes the input text, inteded to be used as a boilerplate for your own applications.
 * See more details in the documentation: https://docs.inworld.ai/docs/node/quickstart
 */
